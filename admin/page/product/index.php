...
<!-- page content  -->
        ...
        <h2 class="text-2xl font-bold text-center mb-6">Product List</h2>

        <!-- Create Product Button -->
        <div class="flex justify-end mb-4">
            <a href="create.php" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">+ Add Product</a>
        </div>
