<footer class="bg-gray-900 text-white px-14 py-10">
  <div class="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
    
    <!-- Brand -->
    <div>
      <h2 class="text-2xl font-bold mb-3">MiniStore</h2>
      <p class="text-gray-400 text-sm">Your one-stop shop for everything.</p>
    </div>
    ...
    <div>
      ...
      <ul class="text-gray-400 text-sm space-y-2">
        <li><i class="fas fa-map-marker-alt mr-2"></i>123 Street, Phnom Penh</li>
        <li><i class="fas fa-phone-alt mr-2"></i>+855 123 456 789</li>
        <li><i class="fas fa-envelope mr-2"></i>support@ministore.com</li>
      </ul>
    </div>
  ...
  <div class="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500 text-sm">
    &copy; <?= date('Y') ?> MiniStore. All rights reserved.
  </div>
</footer>
